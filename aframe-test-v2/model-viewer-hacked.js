...
AFRAME.registerComponent('model-viewer', {
  ...
  initBackground: function () {
    ...
    // Hacked bit: changed radius from 64 to 250 so an environment with radius 200 can be added without getting interfered with
    backgroundEl.setAttribute('geometry', {primitive: 'sphere', radius: 250});
    backgroundEl.setAttribute('material', {
      shader: 'background-gradient',
      // Hacked bit: removed "colorTop: '#37383c', colorBottom: '#757575'," so that default colours can be changed in background-gradient.js
      side: 'back'
    });
